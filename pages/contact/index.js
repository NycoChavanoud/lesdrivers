...
import style from "../../styles/infos_utiles.module.css";
...
export default function infos_utiles() {
  return (
    <Layout pageTitle="Les Drivers - Infos utiles">
      <PhoneButton />
      <h1 className={style.mainTitle}>Infos Utiles</h1>
      ...
      <div className={style.covidContainer}>
        <div className={style.title}>
          Infos <span className={style.redText}> COVID-19</span>
        </div>
            ...
            <div className={style.covidText}>
              <ul className={style.airportList}>
                ...
                <li className={style.airportListItems}>
                  ...
                  <div className={style.airportText}>
                    Lyon a été bâtie sur un site exceptionnel qui abrite deux
                    fleuves et deux collines : la colline « qui prie » :
                    Fourvière » et la colline « qui travaille » : la
                    Croix-rousse. Cette dernière est célèbre pour avoir abrité
                    les canuts au 19ᵉ siècle qui étaient les ouvriers de la
                    Soie. De cette période subsistent de magnifiques
                    appartements qui autrefois leur servaient d’ateliers. Ils
                    sont typiques par la hauteur des plafonds, leurs poutres
                    apparentes et leurs murs en pierre. Depuis la Croix-rousse,
                    redescendez vers le quartier de Hôtel de Ville en empruntant
                    le petit train touristique ou en visitant les traboules
                    lyonnaises, ces passages « secrets » permettant de relier
                ...
                <li className={style.airportListItems}>
                  ...
                  <div className={style.airportText}>
                    ...
                    heure de Grenoble. L’aéroport de Lyon est à environ 150 km
                    de grandes stations comme l’Alpe d’Huez ou Les Deux Alpes.
                    Vous serez conduits par l’un de nos chauffeurs dès la
                    descente de l’avion jusqu’à votre destination ! Courchevel,
                    Tignes, Les Arcs, Méribel, La Clusaz, Val d’Isère, La
                    Plagne… N’hésitez pas à consulter notre tableau des tarifs
          ...
          <div className={style.ButtPrestaWrapper}>
            <div>
              ...
              <h3 className={style.titleText}>
                Voici les avantages des
                <span className={style.redText}> VTC </span>
                pour votre Trajet depuis l’aéropor
                <span className={style.redText}> Lyon Saint-Exupéry</span>,
              </h3>
            </div>
            <div className={style.covidText}>
              <ul className={style.airportList}>
                <li className={style.airportListItems}>
                  ...
                  <div className={style.airportText}>
                    Faciliter votre voyage en louant un minibus avec chauffeur.
